...
//urlMongodbLocalhost = 'mongodb://localhost:27017/';
...
app.post('/carts/:id', (req, res) => {
    ...
    mongoClient.connect(url, function (err, db) {
        if (err) throw err;
        var myobj = {product_id: obj.product_id, product_name: obj.product_name, product_price: obj.product_price, product_image: obj.product_image, quantity: obj.quantity, cart_id: cart_id};
...
app.delete('/carts/:id', (req, res) => {
    ...
    * */
    mongoClient.connect(url, function (err, db) {
        ...
        var query = {cart_id: cart_id};
        var dbo = db.db("cart_db");
        dbo.collection("carts").deleteMany(query, function(err, obj) {
            if (err) throw err;
